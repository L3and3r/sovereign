  ...
  return (
    <div style={{ marginBottom: '1.25rem' }}>
      <button className="help-toggle" onClick={() => setOpen((v) => !v)}>
        <span>{open ? '▾' : '▸'}</span> Hoe speel je dit?
      </button>
      {open && (
        <div className="help-body">
          ...
          <p>
            ...
            industrietypes toe) → industrietype en kaart-opties passen zich automatisch aan → klik Bouw.
          </p>
